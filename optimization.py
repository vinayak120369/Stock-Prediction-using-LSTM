...
INPUT_PATH = r"C:\Users\ACER\Desktop\MCG"
OUTPUT_PATH = os.path.join(r"C:\Users\ACER\Desktop\MCG", "outputs")
...
def init_logging():
    ...
    file_handler = logging.FileHandler(os.path.join(LOG_PATH, "outputs" + ".log")) # "{0}/{1}.log".format(LOG_PATH, LOG_FILE_NAME_PREFIX + get_readable_ctime()))
...
df_ge = pd.read_csv(os.path.join(INPUT_PATH,"AMZN.csv"), engine='python')
...
csv_logger = CSVLogger(OUTPUT_PATH + 'log_' + '.log', append=True)
...
search_space = {
    'batch_size': hp.choice('bs', [10,15,20]),
